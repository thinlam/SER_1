...
public class DanhMucGiamDocInsertCommandValidator : AbstractValidator<DanhMucGiamDocInsertCommand>
{
    public DanhMucGiamDocInsertCommandValidator(IServiceProvider serviceProvider)
    {

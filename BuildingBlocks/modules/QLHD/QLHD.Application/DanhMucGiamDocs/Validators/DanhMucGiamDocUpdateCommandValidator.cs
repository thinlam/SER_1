...
namespace QLHD.Application.DanhMucGiamDocs.Validators;

public class DanhMucGiamDocUpdateCommandValidator : AbstractValidator<DanhMucGiamDocUpdateCommand>
{
    public DanhMucGiamDocUpdateCommandValidator(IServiceProvider serviceProvider)
    {
        RuleFor(x => x.Id)
            .MustAsync(async (id, cancellationToken) =>
            {
                var repository = serviceProvider.GetRequiredService<IRepository<DanhMucGiamDoc, int>>();

...
namespace QLHD.Application.DanhMucNguoiPhuTrachs.Validators;

public class DanhMucNguoiPhuTrachUpdateCommandValidator : AbstractValidator<DanhMucNguoiPhuTrachUpdateCommand>
{
    public DanhMucNguoiPhuTrachUpdateCommandValidator(IServiceProvider serviceProvider)
    {
        RuleFor(x => x.Id)
            .MustAsync(async (id, cancellationToken) =>
            {
                var repository = serviceProvider.GetRequiredService<IRepository<DanhMucNguoiPhuTrach, int>>();

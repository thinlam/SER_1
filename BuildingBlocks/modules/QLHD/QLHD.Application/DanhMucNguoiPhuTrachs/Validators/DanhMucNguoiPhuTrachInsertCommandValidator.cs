...
public class DanhMucNguoiPhuTrachInsertCommandValidator : AbstractValidator<DanhMucNguoiPhuTrachInsertCommand>
{
    public DanhMucNguoiPhuTrachInsertCommandValidator(IServiceProvider serviceProvider)
    {

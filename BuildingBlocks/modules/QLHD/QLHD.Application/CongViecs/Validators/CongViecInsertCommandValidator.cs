...
public class CongViecInsertCommandValidator : AbstractValidator<CongViecInsertCommand>
{
    public CongViecInsertCommandValidator(IServiceProvider serviceProvider)
    {

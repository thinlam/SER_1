...
/// <summary>
/// Model thêm mới/cập nhật thu tiền theo dự án (gộp kế hoạch + thực tế).
/// DuAnId được lấy từ context cha (DuAn).
/// HopDongId được set sau khi có hợp đồng thực hiện thu tiền.
/// </summary>
public class DuAn_ThuTienInsertOrUpdateModel
{
    /// <summary>

...
public record DanhMucNguoiTheoDoiInsertCommand(DanhMucNguoiTheoDoiInsertModel Model) : IRequest<DanhMucNguoiTheoDoi>;

internal class DanhMucNguoiTheoDoiInsertCommandHandler : IRequestHandler<DanhMucNguoiTheoDoiInsertCommand, DanhMucNguoiTheoDoi>
{
    ...
    public DanhMucNguoiTheoDoiInsertCommandHandler(IServiceProvider serviceProvider)
    {
    ...
    public async Task<DanhMucNguoiTheoDoi> Handle(DanhMucNguoiTheoDoiInsertCommand request, CancellationToken cancellationToken = default)
    {
    ...
    private async Task<DanhMucNguoiTheoDoi> InsertAsync(DanhMucNguoiTheoDoiInsertCommand request, CancellationToken cancellationToken)
    {

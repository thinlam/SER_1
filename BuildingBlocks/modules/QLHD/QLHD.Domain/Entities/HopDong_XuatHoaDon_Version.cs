...
/// <summary>
/// Version snapshot of HopDong_XuatHoaDon for KeHoachThang period (Plan data only)
/// </summary>
public class HopDong_XuatHoaDon_Version : Entity<Guid>, IAggregateRoot, IKeHoach
{
    ...
    /// <summary>
    /// ID bản ghi nguồn (FK to HopDong_XuatHoaDon)
    /// </summary>
    ...
    public HopDong_XuatHoaDon? SourceEntity { get; set; }

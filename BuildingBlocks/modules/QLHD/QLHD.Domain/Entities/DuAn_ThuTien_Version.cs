...
/// <summary>
/// Version snapshot of DuAn_ThuTien for KeHoachThang period (Plan data only)
/// </summary>
public class DuAn_ThuTien_Version : Entity<Guid>, IAggregateRoot, IKeHoach
{
    ...
    /// <summary>
    /// ID bản ghi nguồn (FK to DuAn_ThuTien)
    /// </summary>

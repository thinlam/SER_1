...
public class KeHoachKinhDoanhNam_CaNhanConfiguration : AggregateRootConfiguration<KeHoachKinhDoanhNam_CaNhan>
{
    public override void Configure(EntityTypeBuilder<KeHoachKinhDoanhNam_CaNhan> builder)
    {
        builder.ToTable("KeHoachKinhDoanhNam_CaNhan");

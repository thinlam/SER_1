...
/// <summary>
/// Configuration for DuAn_XuatHoaDon - Merged Plan+Actual entity
/// </summary>
public class DuAn_XuatHoaDonConfiguration : AggregateRootConfiguration<DuAn_XuatHoaDon>
{
    public override void Configure(EntityTypeBuilder<DuAn_XuatHoaDon> builder)
    {
        builder.ToTable("DuAn_XuatHoaDon");

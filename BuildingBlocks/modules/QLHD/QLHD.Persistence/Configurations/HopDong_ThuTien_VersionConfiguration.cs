...
/// <summary>
/// Configuration for HopDong_ThuTien_Version - Plan snapshot entity
/// </summary>
public class HopDong_ThuTien_VersionConfiguration : AggregateRootConfiguration<HopDong_ThuTien_Version>
{
    public override void Configure(EntityTypeBuilder<HopDong_ThuTien_Version> builder)
    {
        builder.ToTable("HopDong_ThuTien_Version");

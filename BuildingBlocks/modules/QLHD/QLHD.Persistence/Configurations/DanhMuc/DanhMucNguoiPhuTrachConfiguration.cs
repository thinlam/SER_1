...
public class DanhMucNguoiPhuTrachConfiguration : AggregateRootConfiguration<DanhMucNguoiPhuTrach>
{
    public override void Configure(EntityTypeBuilder<DanhMucNguoiPhuTrach> builder)
    {
        builder.ToTable("DanhMucNguoiPhuTrach");
        ...
        builder.Property(e => e.Ten).IsRequired();
        ...
        // builder.SeedDanhMucNguoiPhuTrach();
    }
}
...
public class DanhMucNguoiTheoDoiConfiguration : AggregateRootConfiguration<DanhMucNguoiTheoDoi>
{
    public override void Configure(EntityTypeBuilder<DanhMucNguoiTheoDoi> builder)
    {
        builder.ToTable("DanhMucNguoiTheoDoi");
        ...
        // builder.SeedDanhMucNguoiTheoDoi();
    }
}
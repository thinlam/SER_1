...
/// <summary>
/// Extension methods cho tìm kiếm theo ISearchString
/// </summary>
public static class SearchExtensions
{
    ...
    /// <summary>
    /// Áp dụng điều kiện Where cho SearchString trên nhiều thuộc tính
    /// </summary>
    /// <typeparam name="T">Kiểu entity</typeparam>
    /// <param name="query">Queryable để filter</param>
    /// <param name="request">Request implement ISearchString</param>
    ...
    public static IQueryable<T> WhereSearchString<T>(
        this IQueryable<T> query,
        ISearchString request,
        params Expression<Func<T, string?>>[] propertySelectors)
    {
        ...
        if (string.IsNullOrWhiteSpace(request.SearchString) || propertySelectors.Length == 0)
            return query;
        ...
        var filterValue = request.SearchString?.Trim().ToLower(System.Globalization.CultureInfo.CurrentCulture) ?? string.Empty;

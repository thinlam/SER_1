...
## 12. Danh mục đơn vị (DanhMucDonVi) - Legacy
...
## 13. Người dùng (NguoiDung) - Legacy
...
| ------------- | ------------------------------------- | ---------------------------------- |
| **Full CRUD** | DanhMucGiamDoc, DanhMucNguoiPhuTrach, DanhMucNguoiTheoDoi, DanhMucLoaiTrangThai, DanhMucTrangThai, DanhMucLoaiHopDong, DanhMucLoaiThanhToan, DoanhNghiep, KhachHang, DuAn, HopDong | Full Create/Read/Update/Delete     |
